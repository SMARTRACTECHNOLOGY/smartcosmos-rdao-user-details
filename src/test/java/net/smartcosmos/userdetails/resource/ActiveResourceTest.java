...
public class ActiveResourceTest {
    ...
    @Ignore
    @Test
    public void thatIsActiveSucceeds() throws Exception {
        ...
        when(authenticateUserService.isUserActive(eq(username))).thenReturn(expectedResponse);

        this.mockMvc.perform(
            post("/active/" + username)
